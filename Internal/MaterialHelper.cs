...
internal sealed unsafe class MaterialHelper
{
    ...
    )
    {
        ...
        if (neutralNormalTexture == null || whiteTexture == null)
            throw new InvalidOperationException("The fixed neutral textures are not ready.");
